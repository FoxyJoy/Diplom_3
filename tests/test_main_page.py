...
class TestMainPageBurgers:
    ...
    def test_follow_to_constructor_page(self, driver):
        ...
        assert main_page.check_constructor_form() and base_page.get_current_url() == Urls.url_main_page
    ...
    def test_follow_to_orders_feed_page(self, driver):
        ...
        assert main_page.check_orders_feed_form() and base_page.get_current_url() == Urls.url_order_feed_form
